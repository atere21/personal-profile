...
function Sidebar() {
  return (
    <div className='sidebar'>
      ...
      <Avatar className="profile__img" src="https://pbs.twimg.com/profile_images/1356228586299142149/ZA8n5UNJ_400x400.jpg"></Avatar>
         <SidebarOption />
          ...
          <div className='slack'>
           ...
           <a href="https://github.com/atere21" target='_blank'><GitHubIcon 
           className='github'/></a>
         </div>
         <h4>HNG Internship 9 Frontend Task</h4>
         <div className='ingressive'>
         
         <img className='btn__zuri' src= "https://internship.zuri.team/static/media/logo.36d2d48a.svg" alt="img" />
